  ...
  return (
    <>
      ...
      />
       ...
       <AsideMenuItem to='/locations' title='Locations' icon='map' />
      ...
      <AsideMenuItem to='/users' title='Users' fontAwesomeIcon="fa-regular fa-user" />
      <AsideMenuItem to='/create-user' title='Create User' fontAwesomeIcon="fa-regular fa-user-plus"  />
